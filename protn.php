   ...
   <!--подключение гугл аналитики для поисковой системы-->
	...
	<div id="wrapper"><!--начало wrapper-->
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" >
		            <h2><span style="color: crimson; font-size: 25px"> Протоколы пробегов</span></h2>
					<?php
                            ...
                            $result2 = mysqli_query($db,'SELECT `dataa`, date(`dataa`) as data1, `name`, `note`, `href`, `img` FROM `prot`');
							//$result2 = mysqli_query($db,"SELECT * FROM `prot`;");
							...
							//					  LIMIT $quantity OFFSET $list;");
							$result = mysqli_query($db,"SELECT `dataa`, LOWER (DATE_FORMAT(`dataa`,'%e %M %Y')) as data1, `name`, `note`, `href`, `img` FROM `prot` Order by `dataa` DESC
                                      LIMIT $quantity OFFSET $list;");					  
        ...
        <div  id="line_8" ><h5>Наши друзья и партнеры: </h5>		
          <div class="d-table">
           <div class="d-tr">
