...
<head>
    ...
    <!--ассинхронная передача данных из формы ввода -->
    <script>
        $(document).ready(function() {
            $('#btn_submit').click(function() {
                ...
                // отправляем данные
                $.ajax({
                    url: "obrsva.php", // куда отправляем
                ...
                if (user_name) {
                    ...
                    message.innerText = "Сообщение не отправлено!";
                }
                let input = $("#user_name");
                input.val('');
                input = $("#user_email");
...
<body id="fon">
    ...
    <div id="wrapper"><!--начало wrapper-->
        ...
        <div id="conteiner">
            <div id="line_6">
                ...
                <div id="prcyru-sqi-counter"></div><noscript><a href="https://pr-cy.ru/" target="_blank"><img
                            src="//a.pr-cy.ru/assets/img/analysis-counter.png" width="88" height="31"
                            alt="Анализ сайта"></a></noscript> -->
            </div>
            <div id="line_7">
                <div class="col-12">
                    <h3 class="text-center  color1 mb-5">Обратная связь</h3>
                    <h5 class="text-center  color1 mb-5">Уважаемые любители бега, для связи напишите ваше сообщение сюда(не публикуется).</h5>
                </div>
                <div class="messages" id="message"></div>
                <label>Ваше имя:</label><br />
                <input type="text" id="user_name" value="" name="fio" /><br />

                <label>Ваш e-mail(не публикуется):</label><br />
                <input type="text" id="user_email" value="" name="email" /><br />

                <label>Ваш tel(не публикуется):</label><br />
                <input type="text" id="user_tel" value="" name="tel" /><br />

                <label>Текст сообщения:</label><br />
                <textarea id="text_comment" name="comment"></textarea>

                <br />
                <input class="btn btn-primary" type="submit" value="Отправить" id="btn_submit" />
                <?php
                ...
                if ($_POST['user_tel'] == "")
                    $errors[] = "Поле 'Ваш tel' не заполнено!";
                ...
                if (empty($errors)) {
                    ...
                    $message .= "Tel пользователя: " . $_POST['user_tel'] . "<br/>";
            ...
            <div id="line_8">
                ...
                <div class="d-table">
                    ...
                    <div class="d-tr">
                        ...
                        <div class="d-td"><a target="_blank" href="http://www.probeg.org/"> <img title="ПроБЕГ в России и мире" src="images/5.gif" alt="ПроБЕГ в России и мире"></a>
                        </div>
                    </div>
                    <div class="d-tr">
                        <div class="d-td"><a target="_blank" href="#"><img title="КЛБ Крыница Бобруйск" src="images/belshina.jpg" alt="КЛБ Крыница Бобруйск" width="50" height="45"></a>
                        </div>
                    ...
                    <div class="d-tr">
                        ...
                        <div class="d-td"><a target="_blank" href="https://betta.by/"><img title="BETTA OCR RACE — это гонка с препятствиями" src="images/bet.png" alt="BETTA OCR RACE — это новая гонка с препятствиями" width="45" height="45"></a>
                        </div>
                    </div>
                </div>
                <!--<div><br><br>
    ...
    <div id="line_9">
        ...
        <h5>© КЛБ &laquo;Свитанок&raquo; г.Жлобин, 2018 - <?php echo date("Y"); ?>.
        </h5>
        <div id="sch1">
        ...
        <div id="sch3">
            <p>
                ...
                <!--<a href="https://metrika.yandex.ru/stat/?id=50681851&amp;from=informer" target="_blank" rel="nofollow"><img src="https://informer.yandex.ru/informer/50681851/3_1_FFA020FF_FF8000FF_0_pageviews" style="width:88px; height:31px; border:0;" alt="Яндекс.Метрика" title="Яндекс.Метрика: данные за сегодня (просмотры, визиты и уникальные посетители)" class="ym-advanced-informer" data-cid="50681851" data-lang="ru" /></a>-->
                <!-- /Yandex.Metrika informer -->
