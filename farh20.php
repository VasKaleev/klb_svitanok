...
<head>
  <meta charset="utf-8" />
	...
	<meta name="description" content="Наш клуб в 1989-2018 годах">
	<meta name="keywords" content="Наш клуб в 1989-2018 годах">
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="style.css" />
    <title>КЛБ &laquo;Свитанок&raquo;-Файловый архив</title> 
	<!--<script src="js/jquery.js" defer></script>-->
	<script src="js/cycle.js" defer></script>
	<!--<script src="js/slideshow.js" defer></script>-->
	<link rel="shortcut icon" href="images/favicon.ico">
	<link rel="canonical" href="http://svitanok.01sh.ru/farh20.php"/>
	...
	<div id="wrapper"><!--начало wrapper-->
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7"><!--<h2 class="d39"></h2>-->
		            <h2><span style="color: crimson; font-size: 25px"> Фотоархив КЛБ &laquo;Свитанок&raquo;</span> </h2>
			        <br>
			        <?php
							...
							$result2 = mysqli_query($db,"SELECT * FROM `farh`;");
							...
							$result = mysqli_query($db,"SELECT * FROM `farh` Order by `datap` DESC
												  LIMIT $quantity OFFSET $list;");
