...
<head>
  <meta charset="utf-8" />
    ...
    <title>КЛБ &laquo;Свитанок&raquo;-Место и адрес побега</title> 
	...
	<div id="wrapper"><!--начало wrapper-->
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" ><br>
		            <a id="sp" href="#" onclick="window.print();return false;"><span style="color: crimson; font-size: 15px"><img class="heardb" title="Распечатать карту" src="../images/sp.jpg" alt="Распечатать карту">  Распечатать карту</span></a><br>
					<?php
                ...
                //$result = mysqli_query($db,"SELECT * FROM `novosti` WHERE `datap` >= curdate() Order by `datap`,`dataa` ASC ");
                //$today = date("Y-m-d");
                $result = mysqli_query($db,'SELECT `dataa`, date(`dataa`) as data1, `name`, `note`, `href`, `img` FROM `novosti` WHERE `dataa` >= curdate() Order by `dataa` ASC');
                //$result = mysqli_query($db,"SELECT * FROM `novosti` Order by `datap` DESC
                ...
                //for ($i = 0; $i<$num_result; $i++) {
				 for ($i = 0; $i<1; $i++) {	
                    $row = mysqli_fetch_array($result);
							...
							//echo 'вывод строк '.$i;
							echo '
							<h2>Адрес пробега на карте</h2>;
                            <a style="margin:0px 20px" target="_blank" href="karta.php/"><img src="images/y.jpg" alt="Адрес пробега" width="90" height="90"/></a><br>';
							}	
							...
							$link=$row["href"];
                			$img=$row["img"];  
                   		echo '<h2><a target="_blank" href='.$link.'>'.$data1.' '.$name.'</a></h2>';
						if ($dataa!="0000-00-00 00:00:00") {
								...
								echo '<font color=#1A7889 size="4pt">До пробега осталось: '.$days.' дней '.$hours.' часов '.$minutes.' минут </font>';
								}
			    ...
			    ?>
					<p></p>
					 <!--<h2 id="karta"><script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A7e146b28594b8f273e6a7e8f9cc9d791eb1ea5a552c7e17bfc286bd034efefe9&amp;width=100%25&amp;height=400&amp;lang=ru_RU&amp;scroll=true;apikey=27824154-696b-48d9-ac91-66e6f0a40488"></script></h2> -->
					 <h2 id="karta"><script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A7e146b28594b8f273e6a7e8f9cc9d791eb1ea5a552c7e17bfc286bd034efefe9&amp;width=100%25&amp;height=400&amp;lang=ru_RU&amp;scroll=true;apikey=27824154-696b-48d9-ac91-66e6f0a40488"></script></h2>
                    <br> <br>
			</div>
			<!--</body>-->
