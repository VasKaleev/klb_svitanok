...
<head>
	...
	<meta name="description" content="Протоколы пробегов в РБ и зарубежом">
	<meta name="keywords" content="Протоколы пробегов в РБ и зарубежом">
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="style.css" />
	<title>КЛБ &laquo;Свитанок&raquo;-Протоколы пробегов</title>
...
<body id="fon">
	...
	<div id="wrapper"><!--начало wrapper-->
		...
		<div id="conteiner">
			...
			<div id="line_7">
				<h2><span style="color: crimson; font-size: 25px">Видео</span></h2>
				<?php
				...
				$result2 = mysqli_query($db, 'SELECT `dataa`, date(`dataa`) as data1, `name`, `note`, `href`, `img` FROM `video`');
				//$result2 = mysqli_query($db,"SELECT * FROM `video`;");
				...
				//$result = mysqli_query($db,"SELECT * FROM `novosti` 
				//                      LIMIT $quantity OFFSET $list;");
				//$result = mysqli_query($db,"SELECT * FROM `video` Order by `datap` DESC
				//					  LIMIT $quantity OFFSET $list;");
				$result = mysqli_query($db, "SELECT `dataa`, LOWER (DATE_FORMAT(`dataa`,'%e %M %Y')) as data1, `name`, `note`, `href`, `img` FROM `video` Order by `dataa` DESC
                                      LIMIT $quantity OFFSET $list;");
				...
				for ($i = 0; $i < $num_result; $i++) {
					...
					echo '<h2><a target="_blank" href=' . $link . '><span style="color: crimson; font-size: 1.0em">' . $data1 . '</span> ' . $name . '</a></h2>';
			...
			<div id="sch2">
				<p>
					...
					<a href="https://top.mail.ru/jump?from=3062632">
						<img src="//top-fwz1.mail.ru/counter?id=3062632;t=479;l=1" style="border:0;" height="31" width="88" alt="Рейтинг@Mail.ru" /></a>
					<!-- //Rating@Mail.ru logo -->
				</p>
			</div>
			<div id="sch3">
				...
				<noscript>
					<div><img src="https://mc.yandex.ru/watch/50681851" style="position:absolute; left:-9999px;" alt="" /></div>
				</noscript>
				<!-- /Yandex.Metrika counter -->
			</div>
			<div id="sch4">
				<p>
					...
					<noscript>
						<a href="http://click.hotlog.ru/?2573473" target="_blank">
							<img src="http://hit20.hotlog.ru/cgi-bin/hotlog/count?s=2573473&im=313" title="HotLog" alt="HotLog"></a>
					</noscript>
					<!-- /HotLog -->
				</p>
			</div>
