...
<head>
  <meta charset="utf-8" />
	...
	<meta name="description" content="Полезные статьи о беге и мотивации">
	<meta name="keywords" content="Полезные статьи о беге и мотивации">
	<link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="style.css" />
    <title>КЛБ &laquo;Свитанок&raquo;-Отчеты</title> 
			...
			<div id="conteiner">
				<div id="line_6">
					...
					<div>
                        ...
                        <div class="pluso" data-background="#ebebeb" data-options="small,square,multiline,horizontal,counter,theme=04" data-services="vkontakte,odnoklassniki,facebook,twitter,google,moimir,email,print" data-url="http://svitanok.01sh.ru/pressa.php" data-title="Пресса о нас. Сайт КЛБ Свитанок г.Жлобин"></div>
					</div>
					
				</div>
		    <div  id="line_7" >
		            <br>
		            <h2><span style="color: crimson; font-size: 25px">Отчёты о соревнованиях.</span></h2><br>
		            <!--<h2><a target="_blank" href="otchet/kor.pdf">KELTY Goverla Race Украина 22 июня 2019 </a></h2><br>
		            <h2><a target="_blank" href="otchet/sp2019.pdf">ХХХ международный марафон "Белые ночи" Санкт-Петербург, Россия, 30 июня 2019</a></h2><br>-->
		            <?php
							...
							$result2=mysqli_query($db,"SET @@lc_time_names = 'ru_RU'");
                            $result2 = mysqli_query($db,'SELECT `dataa`, date(`dataa`) as data1, `name`, `note`, `href`, `img` FROM `otch`');
							//$result2 = mysqli_query($db,'SELECT * FROM `video`');
							//$result=mysqli_query($db,'SELECT * FROM `novosti` '.$sortn.''); // запрос на выборку
							$num = mysqli_num_rows($result2);
							//echo 'число строк'.$num;
							...
							//$result = mysqli_query($db,"SELECT * FROM `prot` Order by `datap` DESC
							//					  LIMIT $quantity OFFSET $list;");
							$result = mysqli_query($db,"SELECT `dataa`, LOWER (DATE_FORMAT(`dataa`,'%e %M %Y')) as data1, `name`, `note`, `href`, `img` FROM `otch` Order by `dataa` DESC
                                      LIMIT $quantity OFFSET $list;");					  
