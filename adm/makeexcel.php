...
$res=mysqli_query($db,'SELECT * FROM `dme10km` ORDER by `let`,`pol`,`fam`,`nomer` ASC'); // Р·Р°РїСЂРѕСЃ РЅР° РІС‹Р±РѕСЂРєСѓ
...
$objWriter->save('den metallurga 10 km.xlsx');
...
echo '<a target="_blank" href="../adm/den metallurga 10 km.xlsx">Открыть файл</a><br/><br/>';
