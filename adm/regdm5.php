...
<head>
  <meta charset="utf-8" />
    <meta name="description" content="КЛБ Свитанок-регистрация 5">
	<meta name="keywords" content="КЛБ Свитанок-регистрация 5 км">
	<link rel="stylesheet" href="../style.css" />
    <title>КЛБ Свитанок-регистрация 5 км</title> 
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" >
				<div>
				    ...
				    <h2><span style="font-family: 'Vollkorn', Serif; color: crimson; font-size: 25px">Регистрация участников пробега день металлурга 5 км Юноши и девушки – до 14 лет;14-16 лет;Мужчины –   70-74; 75 лет и старше.Женщины  –  65-69; 70 лет и старше.</span></h2><br>
			   ...
			   <form action="" method="post">
							<table>
							  <tr>
								<td>  Дистанция  <input type="number" size="20" name="dist"  value="" min="5" max="5" step="" placeholder="5"></td>
							  ...
							  <tr>
								<td>  Адрес  <input type="text" size="50" name="adres"  value=""></td>
							  </tr>
							   <tr>
								<td>  КЛБ  <input type="text" size="20" name="klb"  value=""></td>
							  	<td>  Таб персональн  <input type="text" size="8" name="tabp"  value=""></td>
							  </tr>
							  <tr>
    		   ...
    		   <?php //if(!empty($_POST['fam'])){
					...
					$sql=mysqli_query($db,"INSERT INTO `dme5kmbmz` (`dist`,`rabota`,`datar`,`let`,`pol`,`fam`,`ima`,`otch`,`adres`,`klb`,`tabp`) VALUES ('{$_POST['dist']}', '{$_POST['rabota']}', '{$_POST['datar']}', '{$_POST['let']}', '{$_POST['pol']}', '{$_POST['fam']}', '{$_POST['ima']}', '{$_POST['otch']}', '{$_POST['adres']}', '{$_POST['klb']}', '{$_POST['tabp']}')");
					...
					$q= mysqli_query($db, "SELECT * FROM `dme5kmbmz` where `pol`='m' && `let`<'35' Order by `nomer` ASC");
					echo '<table><tr><td class="dsv1-td">&nbsp;№</td><td class="dsv2-td">Дист</td><td class="dsv3-td">Старт номер</td><td class="dsv4-td">Дата рожден</td><td class="dsv5-td">Полн лет</td><td class="dsv6-td">Фамилия</td><td class="dsv7-td">Имя</td><td class="dsv8-td">Отчество</td><td class="dsv9-td">Клуб</td><td class="dsv9-td">Таб персон</td><td class="dsv11-td">Место работы</td></tr></table>';
					echo 'Мужчины до 35 лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
					   echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn9-td">'.$itog['tabp'].'</td><td class="dsn11-td">'.$itog['rabota'].'</td></tr></table>';
					}
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme5kmbmz` where `pol`='m' && `let`>='35' && `let`<='50' Order by `nomer` ASC");
					echo 'Мужчины 35-50 лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	   echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn9-td">'.$itog['tabp'].'</td><td class="dsn11-td">'.$itog['rabota'].'</td></tr></table>';
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme5kmbmz` where `pol`='m' && `let`>'51' Order by `nomer` ASC");
					echo 'Мужчины 51 и старше лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                    	echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn9-td">'.$itog['tabp'].'</td><td class="dsn11-td">'.$itog['rabota'].'</td></tr></table>';
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme5kmbmz` where `pol`='f' && `let`<'35' Order by `nomer` ASC");
					echo 'Женщины до 35 лет:<br/>';
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                      echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn9-td">'.$itog['tabp'].'</td><td class="dsn11-td">'.$itog['rabota'].'</td></tr></table>';
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme5kmbmz` where `pol`='f' && `let`>='35' && `let`<='50' Order by `nomer` ASC");
					echo 'Женщины 35-50 лет:<br/>';
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	  echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn9-td">'.$itog['tabp'].'</td><td class="dsn11-td">'.$itog['rabota'].'</td></tr></table>';
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme5kmbmz` where `pol`='f' && `let`>'51' Order by `nomer` ASC");
					echo 'Женщины 51 и старше лет:<br/>';
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	   echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn9-td">'.$itog['tabp'].'</td><td class="dsn11-td">'.$itog['rabota'].'</td></tr></table>';
