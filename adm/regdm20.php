...
<head>
  <meta charset="utf-8" />
    <meta name="description" content="КЛБ Свитанок-регистрация день Металлурга 20 км не перв БМЗ">
	<meta name="keywords" content="КЛБ Свитанок-регистрация день Металлурга 20 км не перв БМЗ">
	<link rel="stylesheet" href="../style.css" />
    <title>КЛБ Свитанок-регистрация день Металлурга 20 км не перв БМЗ</title> 
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" >
				<div>
				    ...
				    <h2><span style="font-family: 'Vollkorn', Serif; color: crimson; font-size: 25px">Регистрация участников пробега день металлурга г.Жлобин 20 км </span></h2><br>
			   ...
			   <form action="" method="post">
							<table>
							  <tr>
								<td>  Дистанция  <input type="number" size="20" name="dist"  value="" min="20" max="20" step="" placeholder="20"></td>
							  </tr>
							  <tr>
							  ...
							  <tr>
								...
								<td>  Кем выдан паспорт     <input type="text"  size="50" name="kemvidp"  value="">
							  </tr>
							  <tr>
								<td>  Домашний адрес  <input type="text" size="50" name="adres"  value=""></td>
							  </tr>
							   <tr>
    		   ...
    		   <?php //if(!empty($_POST['fam'])){
					...
					$sql=mysqli_query($db,"INSERT INTO `dme20km` (`dist`,`rabota`,`datar`,`let`,`pol`,`fam`,`ima`,`otch`,`adres`,`klb`,`paspnom`,`datvidp`,`kemvidp`) VALUES ('{$_POST['dist']}', '{$_POST['rabota']}', '{$_POST['datar']}', '{$_POST['let']}', '{$_POST['pol']}', '{$_POST['fam']}', '{$_POST['ima']}', '{$_POST['otch']}', '{$_POST['adres']}', '{$_POST['klb']}', '{$_POST['paspnom']}', '{$_POST['datvidp']}', '{$_POST['kemvidp']}')");
					...
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='m' && `let`<'19' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='m' && `let`>='19' && `let`<='29' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='m' && `let`>='30' && `let`<='39' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					  $q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='m' && `let`>='40' && `let`<='49' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					 $q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='m' && `let`>='50' && `let`<='59' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='m' && `let`>='60' && `let`<='64' Order by `nomer` ASC");
					echo 'Мужчины 60-64 лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	   echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='m' && `let`>='65' Order by `nomer` ASC");
					echo 'Мужчины 65 и старше лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                    	echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='f' && `let`<'19' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='f' && `let`>='19' && `let`<='29' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
    				  $q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='f' && `let`>='30' && `let`<='39' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
    				  $q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='f' && `let`>='40' && `let`<='49' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
    				  $q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='f' && `let`>='50' && `let`<='59' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme20km` where `pol`='f' && `let`>='60' Order by `nomer` ASC");
