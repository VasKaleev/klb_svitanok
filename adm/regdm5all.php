...
<head>
  <meta charset="utf-8" />
    <meta name="description" content="КЛБ Свитанок-регистрация день Металлурга 5 км не перв БМЗ">
	<meta name="keywords" content="КЛБ Свитанок-регистрация день Металлурга 5 км не перв БМЗ">
	<link rel="stylesheet" href="../style.css" />
    <title>КЛБ Свитанок-регистрация день Металлурга 5 км не перв БМЗ</title> 
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" >
							...
							<table>
							  ...
							  <tr>
								<td>  Дата рождения  <input type="date" size="12" name="datar"  value=""></td>
     							<td>  Полных лет  <input type="number" size="2" name="let"  value="" min="3" max="90" step="1"></td>
    		   ...
    		   <?php //if(!empty($_POST['fam'])){
					...
					$sql=mysqli_query($db,"INSERT INTO `dm5km` (`dist`,`rabota`,`datar`,`let`,`pol`,`fam`,`ima`,`otch`,`adres`,`klb`,`paspnom`,`datvidp`,`kemvidp`) VALUES ('{$_POST['dist']}', '{$_POST['rabota']}', '{$_POST['datar']}', '{$_POST['let']}', '{$_POST['pol']}', '{$_POST['fam']}', '{$_POST['ima']}', '{$_POST['otch']}', '{$_POST['adres']}', '{$_POST['klb']}', '{$_POST['paspnom']}', '{$_POST['datvidp']}', '{$_POST['kemvidp']}')");
				...
				$q= mysqli_query($db, "SELECT * FROM `dm5km` where `pol`='m' && `let`<'14' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme10km` where `pol`='m' && `let`>='14' && `let`<='16' Order by `nomer` ASC");
					echo 'Юноши 14-16 лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	   echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dm5km` where `pol`='m' && `let`>='70' && `let`<='74' Order by `nomer` ASC");
					echo 'Мужчины 70-74 лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	   echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
					  ...
					  echo '------------------------------------------------------------------------------------------------<br/>';
					  $q= mysqli_query($db, "SELECT * FROM `dme5km` where `pol`='m' && `let`>='75' Order by `nomer` ASC");
					echo 'Мужчины старше 75 лет:<br/>';		
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	   echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
					...
					$q= mysqli_query($db, "SELECT * FROM `dm5km` where `pol`='f' && `let`<'19' Order by `nomer` ASC");
					...
					while ($itog = mysqli_fetch_assoc($q)) {
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
					$q= mysqli_query($db, "SELECT * FROM `dme5km` where `pol`='f' && `let`<'14' Order by `nomer` ASC");
					echo 'Девушки до 14 лет:<br/>';
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	  echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
    				  $q= mysqli_query($db, "SELECT * FROM `dm5km` where `pol`='f' && `let`>='14' && `let`<='16' Order by `nomer` ASC");
					echo 'Девушки 14-16 лет:<br/>';
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	  echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
    				  $q= mysqli_query($db, "SELECT * FROM `dme5km` where `pol`='f' && `let`>='65' && `let`<='69' Order by `nomer` ASC");
					echo 'Женщины 65-69 лет:<br/>';
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	  echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
    				  ...
    				  echo '------------------------------------------------------------------------------------------------<br/>';
    				  $q= mysqli_query($db, "SELECT * FROM `dm5km` where `pol`='f' && `let`>='70'  Order by `nomer` ASC");
					echo 'Женщины старше 70 лет:<br/>';
					$nn=0;
					while ($itog = mysqli_fetch_assoc($q)) {
					  $nn++;
                   	  echo  '<table><tr><td class="dsn1-td">&nbsp;'.$nn.'</td><td class="dsn2-td">'.$itog['dist'].'</td><td class="dsn3-td">'.$itog['nomer'].'</td><td class="dsn4-td"> '.$itog['datar'].'</td><td class="dsn5-td"> '.$itog['let'].'</td><td class="dsn6-td"> '.$itog['fam'].'</td><td class="dsn7-td"> '.$itog['ima'].'</td><td class="dsn8-td">'.$itog['otch'].'</td><td class="dsn9-td">'.$itog['klb'].'</td><td class="dsn10-td">'.$itog['paspnom'].'</td><td class="dsn11-td">'.$itog['datvidp'].'</td><td class="dsn12-td">'.$itog['kemvidp'].'</td><td class="dsn13-td">'.$itog['rabota'].'</td></tr></table>';
