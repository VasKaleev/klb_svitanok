...
$aSheet->getHeaderFooter()
       ->setOddHeader('5 км день металлурга');
$aSheet->getHeaderFooter()
       ->setOddFooter('&L&B'.$aSheet->getTitle().'5 км день металлурга');
...
$aSheet->setCellValue('A2','дистанция 5 км Юноши и девушки – до 14 лет;14-16 лет;Мужчины –   70-74; 75 лет и старше.Женщины  –  65-69; 70 лет и старше.');
...
$res=mysqli_query($db,'SELECT * FROM `dm5km` ORDER by `let`,`pol`,`fam`,`nomer` ASC'); // Р·Р°РїСЂРѕСЃ РЅР° РІС‹Р±РѕСЂРєСѓ
...
$objWriter->save('den metallurga 5 km ne bmz.xlsx');
...
//echo mb_detect_encoding($pExcel);
echo 'Данные участников пробег день мет 5 км не БМЗ выгружены успешно!';
echo '<a target="_blank" href="../adm/den metallurga 5 km ne bmz.xlsx">Открыть файл</a><br/><br/>';
