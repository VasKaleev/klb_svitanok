   ...
   <!--подключение гугл аналитики для поисковой системы-->
	...
	<div id="wrapper"><!--начало wrapper-->
		<div id="header">
			...
			<div id="line_3">  
				<a href="../index.php"><img loading='lazy' src="../images/0981.png"  alt="foto1" width="171" height="115"/> </a>
				<div id="email">
					<h3>E-mail:</h3>
				...
				<div id="pic">
				<img loading='lazy' title="Пробег день металлурга Жлобин июль 2018" src="../images/dm18.jpg"  width="520" height="200" alt= "КЛБ Свитанок Жлобин" />
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" >
			<h2 class="w3-center">4-10-2020 Discovery Нясвіж</h2>
					<div class="w3-content w3-display-container">
					  <img loading='lazy' title="Discovery Нясвіж" class="mySlides" src="../images/4-10-2020/1.jpg" style="width:100%; height:auto;" alt="Discovery Нясвіж">
					  <img loading='lazy' title="Discovery Нясвіж" class="mySlides" src="../images/4-10-2020/2.jpg" style="width:100%; height:auto;" alt="Discovery Нясвіж">
					  <img loading='lazy' title="Discovery Нясвіж" class="mySlides" src="../images/4-10-2020/3.jpg" style="width:100%; height:auto;" alt="Discovery Нясвіж">
					  <img loading='lazy' title="Discovery Нясвіж" class="mySlides" src="../images/4-10-2020/4.jpg" style="width:100%; height:auto;" alt="Discovery Нясвіж">
					  <img loading='lazy' title="Discovery Нясвіж" class="mySlides" src="../images/4-10-2020/5.jpg" style="width:100%; height:auto;" alt="Discovery Нясвіж">
