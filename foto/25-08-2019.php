...
<head>
  <meta charset="utf-8" />
	...
	<meta name="description" content="КЛБ &laquo;Свитанок&raquo;-Шахтер трэил 25-08-2019">
	<meta name="keywords" content="КЛБ &laquo;Свитанок&raquo;-Шахтер трэил 25-08-2019">
	<link rel="stylesheet" href="../style.css" />
	<!--<link rel="stylesheet" href="../css/lightbox.css" media="screen"/>-->
    <title>КЛБ &laquo;Свитанок&raquo;-Шахтер трэил 25-08-2019</title> 
	...
	<div id="wrapper"><!--начало wrapper-->
		<div id="header">
			...
			<div id="line_3">  
				...
				<img id="new" src="../images/new1.png" loading="lazy"  alt="КЛБ Свитанок Жлобин" width="140" height="140">
				<div id="email">
					<h3>E-mail:</h3>
				...
				<div id="pic">
				<img title="Пробег день металлурга Жлобин июль 2018" src="../images/vena.png"  loading="lazy" width="520" height="200" alt= "КЛБ Свитанок Жлобин" />
					<!--<img src="images/bmz2.gif"  width="520" height="200" alt= "КЛБ Свитанок"/>-->
				</div>
			</div>
			<div id="line_4"><h3>Наши партнеры:</h3>
				<div id="slides">
			    <a style="margin:0px 40px"><img src="../images/ztt.jpg" loading="lazy"  alt="Zhlobin trail team" width="130" height="90"/><p>Zhlobin trail team</p> </a>
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" >
			<h2 class="w3-center">25-08-2019  Шахтер-трэил 2019!!!</h2>
					<div class="w3-content w3-display-container">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/1.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/2.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/3.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/4.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/5.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/6.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск"> 
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/7.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/8.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/9.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
					  <img title="Шахтер-трэил" class="mySlides" src="../images/25-08-2019/10.jpg" style="width:100%; height:auto;" alt="Шахтер-трэил 2019 Солигорск">
                	...
                	<br>
                	<div id="vk_post_-37423296_5645"></div>
                        <script type="text/javascript">
                          ...
                          (function() {
                            if (!window.VK || !VK.Widgets || !VK.Widgets.Post || !VK.Widgets.Post('vk_post_-37423296_5645', -37423296, 5645, 'MLYj4xMijlgUHkG4WLE52fN4cYdB', {width: 300})) setTimeout(arguments.callee, 50);
                          }());
                        </script>
                	<br> <br> <br>
		    </div>
