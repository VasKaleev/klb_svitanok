...
<head>
  <meta charset="utf-8" />
    <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
					<style>
						.mySlides {display: block;margin: 0 auto;}
					</style>
 	<meta name="description" content="КЛБ &laquo;Свитанок&raquo;-Первенство ветеранов 35+ Минск 19-01-2019">
	<meta name="keywords" content="КЛБ &laquo;Свитанок&raquo;-Первенство ветеранов 35+ Минск 19-01-2019">
	<link rel="stylesheet" href="../style.css" />
	<!--<link rel="stylesheet" href="../css/lightbox.css" media="screen"/>-->
    <title>КЛБ &laquo;Свитанок&raquo;-Первенство ветеранов 35+ Минск 19-01-2019</title> 
   ...
   <!--подключение гугл аналитики для поисковой системы-->
	...
	<div id="wrapper"><!--начало wrapper-->
		<div id="header">
			...
			<div id="line_1">
				<!--<p><font size="5pt" face='Playfair Display', serif, font-weight= bold;>Клуб любителей бега &laquo;Свитанок&raquo;</font></p>-->
				<p><font face='Playfair Display, serif'  weight= 'bold'  size="6">Клуб любителей бега &laquo;Свитанок&raquo;</font></p>
			</div>
			<div id="line_3">  
				<!--<a href="../index.php"><img src="../images/0981.png"  alt="foto1" width="171" height="115"> </a>-->
				<img id="new" src="../images/svit.jpg"  alt="КЛБ Свитанок Жлобин" width="135" height="135">
				<div id="email">
					<h3>E-mail:</h3>
		...
		<!--бегущая строка-->
			<div id="line_5">
			<!--<div class="marquee"><span><font face='Playfair Display, serif'  weight= 'bold'  size="4.5"><em> ⚘ ⚘ ⚘ КЛБ &laquo;Свитанок&raquo; поздравляет с открытием бегового сезона 2019. Желаем победы, отличных успехов, везение тоже не станет помехой, других превзойти и себя превозмочь,не дрейфить и гнать все сомнения прочь! ⚘ ⚘ ⚘</em></font></span></div>-->
		    ...
		    <div  id="line_7" >
			<h2 class="w3-center">19-01-2019 ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО ЛЕГКОЙ АТЛЕТИКЕ СРЕДИ ВЕТЕРАНОВ МИНСК-2019</h2>
					<div class="w3-content w3-display-container">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/1.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/2.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/3.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/4.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/5.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/6.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019"> 
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/7.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/8.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/9.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/10.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/11.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/12.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/13.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/14.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/15.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/16.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <img title="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019" class="mySlides" src="../images/19-01-2019/17.jpg" style="width:100%; height:auto;" alt="ОТКРЫТЫЙ ЧЕМПИОНАТ БЕЛАРУСИ В ПОМЕЩЕНИИ ПО Л/А СРЕДИ ВЕТЕРАНОВ МИНСК-2019">
					  <button class="w3-button w3-yellow  w3-display-left" onclick="plusDivs(-1)">&#10094;</button>
					  <button class="w3-button w3-yellow  w3-display-right" onclick="plusDivs(1)">&#10095;</button>
					</div>
		...
		<div class="d-td"><a target="_blank" href="http://www.klbamatar.by/">   <img title="КЛБ Аматар" src="../images/logo_amatar.png" alt="КЛБ Аматар"></a></div>
		   ...
		   <div id="line_9" >
		       <!--<h4>© КЛБ &laquo;Свитанок&raquo; г.Жлобин, 2018.</h4>--> 
		       <p><font face='Playfair Display, serif'  weight= 'bold'  size="4">© КЛБ &laquo;Свитанок&raquo; г.Жлобин, 2018-2019.</font></p>
		       <div id="sch1">  
