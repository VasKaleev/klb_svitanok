...
<head>
  <meta charset="utf-8" />
	...
	<meta name="description" content="Фото отчёты о КЛБ &laquo;Свитанок&raquo; Жлобин">
	<meta name="keywords" content="Фото отчёты о КЛБ &laquo;Свитанок&raquo; Жлобин">
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="style.css" />
    <title>Клуб любителей бега - КЛБ &laquo;Свитанок&raquo;-Фотогалерея</title> 
   ...
   <!--подключение гугл аналитики для поисковой системы-->
	...
	<div id="wrapper"><!--начало wrapper-->
		...
		<!--бегущая строка-->
		    ...
		    <div  id="line_7" ><h2><span style="color: crimson; font-size: 25px">Фотогалерея</span></h2>
		            <?php
                            ...
                            $result2 = mysqli_query($db,'SELECT `dataa`, date(`dataa`) as data1, `name`, `note`, `href`, `img` FROM `foto`');
							//$result2 = mysqli_query($db,"SELECT * FROM `foto`;");
							...
							$result = mysqli_query($db,"SELECT `dataa`, LOWER (DATE_FORMAT(`dataa`,'%e %M %Y')) as data1, `name`, `note`, `href`, `img` FROM `foto` Order by `dataa` DESC
                                      LIMIT $quantity OFFSET $list;");			
							//$result = mysqli_query($db,"SELECT * FROM `foto` Order by `datap` DESC
							//					  LIMIT $quantity OFFSET $list;");
