...
<body id="fon">
	...
	<div id="wrapper"><!--начало wrapper-->
		...
		<div id="conteiner">
			...
			<div  id="line_7">
		            <h2><a target="_blank" href="https://www.sport-express.ru/"> Интернет-портал СПОРТ-ЭКСПРЕСС </a></h2>
		            <!--<а href="images/se.png"><img src="tri.png" width=100 height=100></a>-->
		            <!--<a href='images/se.png'><img src='images/se.png'/></a>-->
		            <p><a target="_blank" href='https://www.sport-express.ru/'><img class="poz" title="Новости спорта сайта tut.by" src="images/se.png" alt="Интернет-портал СПОРТ-ЭКСПРЕСС" width="40" height="40"><b>Ведущий спортивный интернет-портал СПОРТ-ЭКСПРЕСС. Самые свежие новости спорта, обзоры соревнований, интервью со спортсменами.</b></a></p><br><br>
		    </div>
			<div id="line_8">
