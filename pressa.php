...
<head>
  <meta charset="utf-8" />
	...
	<meta name="description" content="Пресса о спротсменах КЛБ &laquo;Свитанок&raquo; Жлобин">
	<meta name="keywords" content="Пресса о спротсменах КЛБ &laquo;Свитанок&raquo; Жлобин">
	<link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="style.css" />
    <title>КЛБ &laquo;Свитанок&raquo;-Пресса о нас</title> 
		...
		<!--бегущая строка-->
			...
			<div id="conteiner">
				<div id="line_6">
					...
					<a href="https://24ho.ru/flag-counter/details/ko/"><img id="rs" src="https://24ho.ru/flag-counter/load/ko/" alt="Flag Counter"></a>
				</div>
		    <div  id="line_7" >
		            <h2><span style="color: crimson; font-size: 25px"> Пресса о нас</span></h2>
					<?php
                                    ...
                                    $result2 = mysqli_query($db,'SELECT `dataa`, date(`dataa`) as data1, `name`, `note`, `href`, `img` FROM `pressa`');
        							...
        							//					  LIMIT $quantity OFFSET $list;");
        							$result = mysqli_query($db,"SELECT `dataa`, LOWER (DATE_FORMAT(`dataa`,'%e %M %Y')) as data1, `name`, `note`, `href`, `img` FROM `pressa` Order by `dataa` DESC
                                      LIMIT $quantity OFFSET $list;");					  
